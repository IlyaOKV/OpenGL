...
{
public:
	static constexpr double DEFAULT_WALK_DISTANCE = 0.001;
	static constexpr double DEFAULT_TURN_ANGLE = 0.002;
	static constexpr double VERTICAL_LIMIT1 = 0.005;
	static constexpr double VERTICAL_LIMIT2 = 1.0;
