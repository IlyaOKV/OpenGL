...
void DemoWindow::render() {
	...
	glScaled(_cube_scale,_cube_scale,_cube_scale); //преобразование масштаб - сжатие или растяжение вдоль вектора, умножая
												   //координаты вершин на значение заданным параметров
